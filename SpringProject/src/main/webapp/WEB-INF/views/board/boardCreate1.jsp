...
<head>
  ...
  <title>1대1 게시글 등록하기</title>
  <meta content="" name="description">
  <meta content="" name="keywords">
  <link rel="stylesheet" type="text/css" href="href=${path}/resources/assets/css/mystyle.css">
</head>
<body>
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form id="detailform" method="post" class="row g-3"
               ...
               <input type="hidden" value="${login.name}" readonly="true"
                  class="form-control" id="id" name="id" />
                  
                  <input type="text" value="${login.kakaoid}" readonly="true"
                  class="form-control" id="kakaoid" name="kakaoid" />
                <!--  성별 -->
                
               <input type="hidden" value="${login.sex}" class="form-control" id="sex" name="sex" />
                
                <!--  나이 -->
                <div class="col-md-4">
                  <div class="form-floating mb-3">
                    <select class="form-select" id="age" name= "age" aria-label="State" size="1">
                ...
                <div class="text-center" id="footbox">
