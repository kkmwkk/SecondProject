            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">남서울대 인증 로그인</h5>
                    <p class="text-center small">학번과 비밀번호를 입력하세요</p>
                  </div>

                  <form class="row g-3 needs-validation" novalidate action="<c:url value='first' />" method="post">
